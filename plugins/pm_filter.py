 ...
 #   if user_id in ADMINS: return
    ...
    if await db.get_pm_search_status(bot_id):
        ...
        await message.reply_text("<b><i>ɪ ᴀᴍ ɴᴏᴛ ᴡᴏʀᴋɪɴɢ ʜᴇʀᴇ. ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ.</i></b>",
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ ", url=f'https://t.me/Filmy_Rohesh')]]))
...
InlineKeyboardButton('⇋ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ⇋', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
                            ...
                            InlineKeyboardButton('⛩️ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ⛩️', url=f'https://t.me/Filmy_Rohesh')
                        ]] 
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        m=await query.message.reply_sticker("CAACAgUAAxkBAAEGA5hnH6lxKP4BbxSDUxpDGjwYMN9xaQAC2Q8AAitnKVT-TfgnLJsQCx4E") 
        await m.delete()
        ...
        buttons = [[
            InlineKeyboardButton('☆📸 𝙎𝙚𝙣𝙙 𝙨𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 📸☆', url=f'https://t.me/TitanContactBot')
        ],[
    ...
    # If the user isn't an admin, return
      ...
      await client.edit_message_media(
          ...
          media=InputMediaAnimation(
            media="CAACAgUAAxkBAAEGA5hnH6lxKP4BbxSDUxpDGjwYMN9xaQAC2Q8AAitnKVT-TfgnLJsQCx4E",
       ...
       await client.edit_message_media(
        ...
        buttons = [[
            InlineKeyboardButton('Repo', url='https://t.me/Rohesh_Gavit')
        ],[
       ...
       buttons = [[
	      InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
              ...
              InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url=f'https://t.me/Filmy_Rohesh_Disscussion'),
       ]]
       reply_markup = InlineKeyboardMarkup(buttons)
       await client.edit_message_media(
          chat_id=query.message.chat.id,
